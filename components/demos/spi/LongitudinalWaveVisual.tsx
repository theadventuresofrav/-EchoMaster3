...
const LongitudinalWaveVisual: React.FC = () => {
  return (
    <div className="w-full h-64 rounded-lg bg-gray-900/50 border border-white/10 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="w-full max-w-md mx-auto">
        ...
        {/* Labels */}
        <p className="absolute top-1/4 left-1/4 text-xs font-mono text-white/70">Compression</p>
        <p className="absolute bottom-1/4 right-1/4 text-xs font-mono text-white/70">Rarefaction</p>

      </div>
      <p className="absolute bottom-2 right-4 text-xs text-white/60 font-mono">Visualization: Longitudinal Wave</p>
    </div>
  );
};

export default LongitudinalWaveVisual;
